...
import {
  ...
  DrawerTitle,
  DrawerTrigger,
} from '@/lib/shadcn-ui/components/ui/drawer';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { useIsMobile } from '@/lib/shadcn-ui/hooks/use-mobile';
...
function DropDrawerContent({
  ...
  const [animationDirection, setAnimationDirection] = React.useState<'forward' | 'backward'>(
    'forward'
  );
