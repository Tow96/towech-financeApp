...
describe('"useValue" functions', () => {
  beforeAll(async () => {
    const moduleRef = await Test.createTestingModule({
      providers: [DummyRepo, { provide: getModelToken(DummyDoc.name), useValue: DummyModel }],
    }).compile();
  ...
  describe('When create is called', () => {
    ...
    beforeEach(async () => {
      saveSpy = jest.spyOn(DummyModel.prototype, 'save');
      constructorSpy = jest.spyOn(DummyModel.prototype, 'constructorSpy');
