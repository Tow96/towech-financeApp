...
const WalletForm = (props: Props): JSX.Element => {
  ...
  async function editWalletCallback() {
    try {
      ...
      const editedWallet = walletForm.values;
  ...
  const acceptIcon = <div>S</div>; //<FaIcons.FaSave />;
  ...
  const calculateFree = (): string => {
    ...
    props.initialWallet.child_id?.map((x: any) => {
        ...
        <div className="WalletForm">
          ...
          {props.initialWallet && (
            <>
              ...
              <div>
                <Button className="WalletForm__Delete" onClick={() => setDeleteWarn(true)}>
                  <>
                    {/* <div className="NewWalletForm__Delete__Icon"> */}
                    <FontAwesomeIcon icon="trash-alt" className="WalletForm__Delete__Icon" />
                    {/* </div> */}
                    Delete Wallet
                  </>
                </Button>
...
const SubWalletForm = (props: SubWalletProps): JSX.Element => {
  ...
  async function editWalletCallback() {
    try {
      ...
      const editedWallet = subWalletForm.values;
      editedWallet._id = props.initialWallet._id;
      // Sends the wallet to the API
      const res = await transactionService.editWallet(editedWallet, setLoading);
      // Sets the wallet and closes the modal
    ...
    <>
      <Modal
        ...
        <div className="WalletForm">
          ...
          {props.initialWallet && (
            <div>
              <Button className="WalletForm__Delete" onClick={() => setDelete(true)}>
                <>
                  {/* <div className="NewWalletForm__Delete__Icon"> */}
                  <FontAwesomeIcon icon="trash-alt" className="NewWalletForm__Delete__Icon" />
                  {/* </div> */}
                  Delete SubWallet
                </>
              </Button>
