...
const TransactionForm = (props: Props): JSX.Element => {
  ...
  const acceptIcon = <FontAwesomeIcon icon="save" />;
        ...
        <div className="TransactionForm">
          ...
          <div className="TransactionForm__Content">
            ...
            <CategorySelector
              ...
              visible={props.state}></CategorySelector>
            ...
            <Checkbox
              ...
              onChange={transactionForm.onChange}></Checkbox>
          ...
          {props.initialTransaction && (
            <div>
              <Button className="TransactionForm__Delete" onClick={() => setDeleteWarn(true)}>
                <>
...
const WalletSelector = (props: WalletSelectorProps): JSX.Element => {
  ...
  const [selectedWallet, setSelectedWallet] = useState(null as any | null);
  ...
  const getSelectedWalletClass = (wallet: any): string => {
