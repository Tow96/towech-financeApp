...
interface AccordionItemProps extends React.ComponentProps<typeof AccordionPrimitive.Trigger> {
	empty?: boolean
}

function AccordionTrigger({ className, children, empty, ...props }: AccordionItemProps) {
	return (
